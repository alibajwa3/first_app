              ...
              child: Wrap(
                children: <Widget>[
                  ListTile(
                      ...
                      onTap: () {
                        imageController.get(ImageSource.gallery);
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      imageController.get(ImageSource.camera);
                      Navigator.of(context).pop();
                    },
                  ),
                ],
    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Align(
                        ...
                        child: Image.asset("assets/images/bgc.png")),
                    Align(
                        alignment: const Alignment(0.64, 0.64),
                        child: Image.asset("assets/images/bgd.png")),
                  ],
                ),
              ),
            ),
            ...
            child: Obx(
              () => DropdownButton(
                ...
                items: locationController.locations.map((String value) {
                  return DropdownMenuItem(value: value, child: Text(value, style: const TextStyle(fontFamily: "Poppins"),));
                }).toList(),
              ),
            ),
          ),
          ...
          const WhiteText("Register As", 16, FontWeight.w600, AppColors.black),
          const SizedBox(
            height: 15,
          ),
          Container(
            ...
            child: Obx(
              () => DropdownButton(
                ...
                onChanged: (newValue) {
                  registrationOptionController.setSelected(newValue as String);
                },
                value: registrationOptionController.selectedOption.value,
                items: registrationOptionController.options.map((String value) {
                  return DropdownMenuItem(value: value, child: Text(value, style: const TextStyle(fontFamily: "Poppins"),));
                }).toList(),
              ),
            ),
          ...
          const WhiteText("You can change it from the settings after login", 10,
